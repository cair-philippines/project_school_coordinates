...
COORD_PRIORITY = [SOURCE_MONITORING, SOURCE_OSM, SOURCE_NSBI, SOURCE_GEOLOCATION]

# Priority order for location columns
LOCATION_PRIORITY = [SOURCE_NSBI, SOURCE_GEOLOCATION, SOURCE_MONITORING, SOURCE_OSM]
